...
export default function ModelosEmailFinanceiroPage() {
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-3xl font-bold text-gray-900">Modelos de E-mails</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden hover:border-[#38b473] transition-all group">
          ...
          <div className="p-4">
            <h4 className="font-bold text-gray-800">Cobranca de Vencimento</h4>
            <p className="text-xs text-gray-500 mt-1">Enviado 3 dias antes do vencimento do boleto.</p>
          </div>
        </div>
